  ...
  Future<String> requestCode() async {
    if (shouldRequestCode() && !isBrowserOpen) {
      ...
      webView.launch("${requestDetails.url}?$urlParams",
          clearCookies: requestDetails.clearCookies,userAgent:"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36");
